...
public interface ComentarioRepository extends JpaRepository<Comentario, Long> {
    @Query("select new com.surrogate.Zoolip.models.DTO.ComentarioDTO(c.id_comentario, c.contenido, c.id_usuario.nombre,c.likes, c.id_publicacion.id_publicacion) from Comentario c")
    List<ComentarioDTO> findAllComentariosDTO();

    @Query("select new com.surrogate.Zoolip.models.DTO.ComentarioDTO(c.id_comentario, c.contenido, c.id_usuario.nombre, c.likes,c.id_publicacion.id_publicacion) from Comentario c where" +
