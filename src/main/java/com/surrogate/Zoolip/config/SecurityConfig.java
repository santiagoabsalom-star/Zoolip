    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/api/institucion/obtenerPorId").hasAnyAuthority("ROLE_ADMIN", "ROLE_ADMINISTRADOR", "ROLE_SYSTEM", "ROLE_USUARIO","ROLE_USER")
                        .requestMatchers("/api/institucion/obtenerTodas").hasAnyAuthority("ROLE_ADMIN", "ROLE_ADMINISTRADOR", "ROLE_SYSTEM","ROLE_USUARIO","ROLE_USER")
                        ...
                        .requestMatchers("/api/institucion/obtenerPorIdUsuario").hasAnyAuthority("ROLE_ADMIN", "ROLE_ADMINISTRADOR", "ROLE_SYSTEM","ROLE_USUARIO","ROLE_USER")
