...
public record PublicacionDTO(Long idPublicacion, String avatarUrl, long idUsuario, Tipo tipo, String contenido, String topico, String nombreUsuario, Integer likes,
